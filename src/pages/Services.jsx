...
const SERVICES = [
  {
    ...
    price: '$3,000',
    desc: 'A structured, facilitator-led deep dive into the 12-Step recovery framework. Designed for individuals dealing with any and all addictions, this program builds a strong foundation through honest self-examination, accountability, and a commitment to lasting change.',
    icon: (
  ...
  },
  {
    ...
    price: '$2,000',
    desc: 'A science-based alternative to traditional 12-Step programs. SMART Recovery uses evidence-based tools and techniques to help individuals build motivation, manage urges, and develop a balanced approach to long-term recovery.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    details: ['30 hours', '15 sessions of 2 hours each'],
    price: '$3,000',
    desc: 'A culturally grounded recovery program that blends the 12-Step framework with Indigenous teachings and the Medicine Wheel. Wellbriety honors the whole person — mind, body, spirit, and emotion — on the journey to sobriety and wellness.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    price: '$1,500',
    desc: 'Monthly one-on-one assessments designed to track recovery progress, identify emerging barriers, and strengthen the personal, social, and community resources that support long-term stability. Delivered over a 12-month contract.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
