...
const CARDS = [
  ...
  },
  {
    ...
    desc: 'Formally certified in BC Peer Support, SMART Recovery, Wellbriety, Grief Walk facilitation, and Addiction Care and Treatment. This combination of certification and lived experience allows us to engage clients in ways that improve trust, retention, and follow-through.',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
